...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            ...
            + COLUMN_USER_ADDRESS + " TEXT, " + COLUMN_USER_EMAIL + " TEXT,"  + COLUMN_USER_PASSWORD + " TEXT"+
            ")";
    ...
    public List<User> getAllUser() {
        ...
        /**
         * function is used to fetch records from user table this function works like we use sql query.
